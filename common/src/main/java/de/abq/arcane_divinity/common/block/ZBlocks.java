...
public final class ZBlocks {
    public static final Block arcaneShrineBlock = new ArcaneShrineBlock(BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).strength(3).noOcclusion());
    ...
    public static void registerBlocks(BiConsumer<Block, ResourceLocation> register){
        register.accept(arcaneShrineBlock, ZBlockNames.ARCANE_SHRINE);
    ...
    public static void registerBlockItems(BiConsumer<Item, ResourceLocation> register){
        ...
        register.accept(blockItemHelper(arcaneShrineBlock, props), BuiltInRegistries.BLOCK.getKey(arcaneShrineBlock));
