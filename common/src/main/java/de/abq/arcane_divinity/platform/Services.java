...
public final class Services {
    ...
    // mod is loaded.
    public static final ArcaneDivinityPlatformHelper PLATFORM = load(ArcaneDivinityPlatformHelper.class);
    public static final ArcaneDivinityRegistrationHelper PLATFORM_REGISTER = load(ArcaneDivinityRegistrationHelper.class);
