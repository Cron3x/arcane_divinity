...
val modVersion = libs.get().findVersion("arcane.divinity").get()
...
val veilVersion =  libs.get().findVersion("veil").get()//"1.0.0.80"find out how to make this work with veils versions
